...
```{r Build histogram of mean total number of steps taken per day, message=FALSE}
...
```{r Plotting aggregated interval vs steps count data}
qplot(
...
```{r Histogram of average number of steps taken each day using clean data, message=FALSE}
...
```{r Comparing weekday and weekend activity patterns,message=FALSE}
